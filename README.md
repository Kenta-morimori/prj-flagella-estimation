...
この可視化は `*_category_heatmap.png` に加えて、body と hook をまとめた `*_combined_pass_fail_heatmap.png` を出力する。
`*_flagella_pass_fail_heatmap.png` は、flag 系の first-fail がある場合にのみ追加で出力される。

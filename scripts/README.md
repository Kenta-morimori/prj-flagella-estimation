...
| active diagnostic | `compare_axis_angle_references.py --config ...` | #215の2 s / 5 s body--flagella axis angle比較 | `src/sim_swim/analysis/axis_angle_comparison.py` | active diagnostic |
| active diagnostic | `stage_issue215_reference.py --campaign-dir ...` | #215のcompact成果物を検証してlocal referenceへ配置 | `scripts/03_dataset_building/stage_issue215_reference.py` | active diagnostic |

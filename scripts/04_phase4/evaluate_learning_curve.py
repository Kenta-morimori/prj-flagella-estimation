#!/usr/bin/env python3
"""Evaluate a grouped Phase 4 baseline learning curve."""
...
def main(argv: list[str] | None = None) -> None:
    ...
    cfg = load_learning_curve_config(config_from_key or args.config, args.overrides)
    output_dir = evaluate_grouped_learning_curve(cfg)
    print(output_dir)

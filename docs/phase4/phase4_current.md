...
- #128: 学習datasetへ混ぜてよい条件変更をmachine-readable freeze gateへ接続した。
...
1. #128 machine-readable freeze gateをreview / mergeする。
2. #129で`k=4`をMVP dataset-size下限として採用するか，protected評価用runを追加してから決めるかを判断する。

...
- accepted note: 2026-06-03時点では、`P2-8-007` の後方束化判定を統合し、採択済みタスク `docs/phase2/phase2_tasks.md#p2-7-006-複数べん毛で崩壊せず後方束化する条件を探索する` として扱う。
...
- accepted note: 2026-06-03時点では、独立タスクではなく `P2-7-006` に統合する。後方束化は、非崩壊条件探索と同じ実験条件で評価する。
...
- accepted note: 2026-06-03時点では、P2-7/P2-8統合により採択済みタスク `P2-8-008` として扱う。3D出力サンプリングは別タスク `P2-9-009` に分離する。

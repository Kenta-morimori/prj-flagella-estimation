...
Cloud review は merge 直前の final candidate に対して原則1回だけ要求する。指摘が出た場合は，未解決の actionable review threads を一括取得し，まとめて修正してから1回だけ follow-up review を要求する。Cloud review を commit ごとの lint 代わりに使わない。

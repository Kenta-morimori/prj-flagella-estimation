...
* Phase 2.8 / Issue #71: RUN固定状態で，べん毛本数による菌体推進・姿勢安定性・軸整列の違いをdatasetとして評価する後続分析を進める。
...
* #71 では body displacement, speed, body axis angle change, angular velocity, wobble RMS, flag helix axis alignment を本数別に比較する必要がある。

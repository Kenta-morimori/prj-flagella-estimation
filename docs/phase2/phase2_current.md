...
* Phase 2.8 / Issue #72: 親Issue #71 のRUN固定べん毛数差分析に向けて，複数条件実行スクリプトとdataset builderを追加済み。初期dataset IDは `fc_nf1_2_3_6_seed3_dur0p5`。
...
* #71 では #72 のdataset出力を使い，body displacement, speed, body axis angle change, angular velocity, wobble RMS, flag helix axis alignment を本数別に比較する必要がある。

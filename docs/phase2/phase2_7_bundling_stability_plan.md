...
2. 第2ビーズ以降の螺旋中心軸を菌体後方へ向けた初期条件を作る。
3. 後方螺旋軸条件で安定トルク帯を再探索し、後方束化候補を分類する。
...
- 自然初期条件と後方螺旋中心軸条件のそれぞれについて、torque と分類結果の表がある。
...
この実装で確認する主な問いは、「全べん毛の螺旋本体の軸が同一に後方へ向いた初期条件で、束化または部分束化が見られるか」である。fail判定時でも、螺旋間距離・bundle radius・3D軸overlayを確認し、定量gateだけでは見落とす部分束化を拾えるようにする。

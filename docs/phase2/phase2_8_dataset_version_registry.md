...
| `v1` | `r0` | `nf1_2_3_4_as3_ps3_dur1p0` candidate | planned | `training_candidate` | TBD after #119 smoke check | `flag_spring2p25_body2p5_candidate` | `conf/phase2_multi_run/flagella_count_behavior_v1.yaml` planned | `v1` planned | `not_generated` | none | #116 seed00 では `n=4` のみ v1-ready 自動指標 pass。#119 冒頭で `n=1,2,3` smoke check と seed expansion を確認し，`n=1..4` training candidate 可否を確定する。`n=5,6` は現時点で除外。 |

...
| `v1` | `r0` | TBD | planned | `planned` | TBD | TBD after #115 | TBD | TBD | `not_generated` | none | #115 の改善モデルを受けて #119 で再生成し，v0 と比較する。 |
...
v1 は #115 のモデル改善結果を受けて #119 で作成する。v1 config は原則として `conf/phase2_multi_run/flagella_count_behavior_v1.yaml` とし，dataset_id は `v1` とする。
